...
onMounted(() => gsap.set(postBtn.value.$el, { xPercent: -50, yPercent: -50 }))
...
<template>
  <div class="sticky top-4 z-50 flex justify-center px-4">
    <nav
      class="relative flex w-[340px] items-center justify-between gap-3 rounded-full border border-white/15 bg-graphite/45 px-5 py-3 text-wall shadow-[inset_0_1px_0_rgba(255,255,255,0.35),inset_0_-1px_0_rgba(0,0,0,0.2),0_8px_32px_rgba(0,0,0,0.3)] backdrop-blur-xl backdrop-saturate-150"
    >
      ...
      >
        ...
        <span class="text-[13px] font-medium leading-none">Post</span>
      </RouterLink>
